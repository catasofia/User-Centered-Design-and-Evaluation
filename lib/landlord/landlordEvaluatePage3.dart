...
//Marco
class LandlordEvaluatePage3 extends StatefulWidget {
  LandlordEvaluatePage3({Key? key}) : super(key: key);

  @override
  _LandlordEvaluatePage3State createState() => _LandlordEvaluatePage3State();
}

final textController_1 = TextEditingController();

class _LandlordEvaluatePage3State extends State<LandlordEvaluatePage3> {
  bool _star1 = false;
  bool _star2 = false;
  bool _star3 = false;
  bool _star4 = false;
