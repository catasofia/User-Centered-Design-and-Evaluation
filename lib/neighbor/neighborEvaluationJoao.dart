...
import 'package:time_app/neighbor/joaoProfile.dart';
...
class NeigEvaluationJoao extends StatefulWidget {
  NeigEvaluationJoao({Key? key}) : super(key: key);

  @override
  _NeigEvaluationJoaoState createState() => _NeigEvaluationJoaoState();
}

final textController_1 = TextEditingController();

class _NeigEvaluationJoaoState extends State<NeigEvaluationJoao> {
  bool _star1 = false;
  bool _star2 = false;
  bool _star3 = false;
  bool _star4 = false;
                    ...
                    children: <Widget>[
                      RaisedButton(
                        ...
                        onPressed: () {
                          ...
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => JoaoProfile()),
                          );
                        },
                      ),
                    ],
