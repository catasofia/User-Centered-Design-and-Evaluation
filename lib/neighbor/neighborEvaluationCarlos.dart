...
class NeigEvaluationCarlos extends StatefulWidget {
  NeigEvaluationCarlos({Key? key}) : super(key: key);

  @override
  _NeigEvaluationCarlosState createState() => _NeigEvaluationCarlosState();
}

final textController_1 = TextEditingController();

class _NeigEvaluationCarlosState extends State<NeigEvaluationCarlos> {
  bool _star1 = false;
  bool _star2 = false;
  bool _star3 = false;
  bool _star4 = false;
