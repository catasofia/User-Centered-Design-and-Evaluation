...
import 'carolinaProfile.dart';

class NeigEvaluationCarolina extends StatefulWidget {
  NeigEvaluationCarolina({Key? key}) : super(key: key);

  @override
  _NeigEvaluationCarolinaState createState() => _NeigEvaluationCarolinaState();
}

final textController_1 = TextEditingController();

class _NeigEvaluationCarolinaState extends State<NeigEvaluationCarolina> {
  bool _star1 = false;
  bool _star2 = false;
  bool _star3 = false;
  bool _star4 = false;
                    ...
                    children: <Widget>[
                      RaisedButton(
                        ...
                        onPressed: () {
                          ...
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => CarolinaProfile()),
                          );
                        },
                      ),
                    ],
